...
//
	...
	private static String url =  "jdbc:mysql://192.168.0.160/boss_test";
	private static String username = "javaapp";
	private static String password = "javaapp@123";
	...
	private static  final  String basePackage = "com.vcg.boss";
	private static final String project = "boss_schedualbase";
	private final static String DESTPATH = "/Users/lizhenhe/Downloads/"+project+"/";

	public static void main(String[] args) throws Exception {
		GeneratorSqlmapSchedual generatorSqlmap = new GeneratorSqlmapSchedual();
