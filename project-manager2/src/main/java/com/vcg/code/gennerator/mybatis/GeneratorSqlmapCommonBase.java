...
//	private static String url = "jdbc:mysql://192.168.3.160/boss";
//	private static String username = "dev_boss";
//	private static String password = "zkun@1233";
...
//
// 	private static String url = "jdbc:mysql://rm-2zerzfys20019ig27o.mysql.rds.aliyuncs.com/boss?useSSL=true";
//  private static String username = "docker_suhua";
//	private static String password = "docker_suhua@123";
//


	private static String url =  "jdbc:mysql://192.168.0.160:3307/boss";
	private static String username = "mysql";
	private static String password = "mysql1a2s";
	...
	private static  final  String basePackage = "com.vcg.boss.price";
	private static final String project = "boss_settlebase";
	private final static String DESTPATH = "/Users/zhenheli/Downloads/"+project+"/";

	public static void main(String[] args) throws Exception {
		GeneratorSqlmapCommonBase generatorSqlmap = new GeneratorSqlmapCommonBase();
		boolean isGenerator=false;
		List lst=null;
		lst=Arrays.asList(
				"s_options_rrvideo",
				"s_options_new_edtorial_video",
				"s_option_use_base_price_rrvideo",
				"s_option_use_base_price_new_editorial_video"
//				"s_bill"//,
//				"s_bill_detail"//,
//				"s_bill_detail_othercharge"//,
//				"s_bill_othercharge_type_d"//,
//				"s_contract"
//				"s_contract_amount"
//				"u_role_department",
//				"u_role_principal"
//				"s_contract_history"
//				"s_contract_history_content"
//				"s_contract_info", //合同联系人信息表
//				"s_contract_content",
//				"s_contract_territory_d"//,
//				"s_contract_use_category_d"//
//				"s_contract_benefit_schedual"
//				"s_lawyer_office"，
//				"s_contract_auth_price"
//				"s_contract_auth_product",
//				"s_contract_auth_user"
//				"s_contract_auth_product_product"
//				"i_down_record"
//				"u_user_role"
//				"u_out_role",
//				"u_out_permission"
//				"u_out_role_permission"
//				"auth_rule",
//				"auth_rule_collection",
//				"auth_rule_account",
//				"auth_rule_account_type",
//				"auth_rule_region",
//				"auth_rule_log"
				);
		//lst=new ArrayList();

		FileInputStream in = generatorSqlmap.genneratorCloud(url, username, password, driverClass, project, basePackage,
				lst,isGenerator);
		...
		IOUtils.copy(in, new FileOutputStream(new File( DESTPATH + "/outstorage.zip")));
		System.err.println("生成ok....");

		unZipFiles( DESTPATH + "outstorage.zip", DESTPATH );
