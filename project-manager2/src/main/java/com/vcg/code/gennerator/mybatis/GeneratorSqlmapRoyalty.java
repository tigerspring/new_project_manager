...
//
	...
	private final static String DESTPATH = "/Users/lizhenhe/Downloads/royalty/";

	public static void main(String[] args) throws Exception {
		GeneratorSqlmapRoyalty generatorSqlmap = new GeneratorSqlmapRoyalty();
		boolean isGenerator=false;
		List lst=null;
		lst=Arrays.asList(
//				"s_net_value_msg"
				"s_net_value_month_sub_amount"
				);
		//lst=new ArrayList();

		FileInputStream in = generatorSqlmap.genneratorCloud(url, username, password, driverClass, "royalty", "com.vcg.boss.royalty",
				lst,isGenerator);
